...
CHAT_ID = os.getenv("CHAT_ID")  # يمكن تركه فاضي إذا بدك يعتمد على كل المرسلين
...
def check_prices():
    for symbol in r.keys():
        ...
        try:
            ...
            print(f"خطأ في check_prices مع {symbol}: {e}")
...
def webhook():
    try:
        ...
        send_message("⚠️ حصل خطأ أثناء المعالجة، جرب مرة أخرى.")
